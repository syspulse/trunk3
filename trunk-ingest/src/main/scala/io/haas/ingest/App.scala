...
import io.haas.ingest.icp
import io.haas.ingest.starknet
import io.haas.ingest.vechain
import io.haas.ingest.stellar
import io.haas.ingest.solana
import io.haas.ingest.bitcoin

import io.haas.intercept.store._
import io.haas.intercept.server.InterceptRoutes
  ...
  def main(args:Array[String]):Unit = {
    ...
    val c = Configuration.withPriority(Seq(
      ...
      new ConfigurationArgs(args,"trunk3","0.14.0",
        ...
        ArgCmd("replay",s"Replay mode (requires -e <entity>) and --block/--filter"),
